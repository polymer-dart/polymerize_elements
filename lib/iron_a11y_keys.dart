...
@JS('IronA11yKeys')
@PolymerRegister('iron-a11y-keys',native:true)
@BowerImport(ref:'PolymerElements/iron-a11y-keys#v2.0.0',import:"iron-a11y-keys/iron-a11y-keys.html",name:'iron-a11y-keys')
abstract class IronA11yKeys extends PolymerElement implements imp0.IronA11yKeysBehavior {
  /**
   * @type {?Node}
   */
  external  get target;
  external set target( value);
   ...
   */
  external String get keys;
  external set keys(String value);
